package com.horay.testmci.Adapter
...
import com.horay.testmci.databinding.BookmarkViewBinding
import com.horay.testmci.databinding.LongBookmarkViewBinding
    ...
    override fun onBindViewHolder(holder: MyHolder, position: Int) {
        ...
        holder.root.setOnClickListener{
            when{
                ...
                else -> Snackbar.make(holder.root, "اینترنت متصل نیست\uD83D\uDE03", 3000).show()
            }
