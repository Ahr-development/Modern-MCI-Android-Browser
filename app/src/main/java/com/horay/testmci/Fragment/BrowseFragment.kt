...
import com.horay.testmci.databinding.FragmentBrowseBinding
...
class BrowseFragment(private var urlNew: String) : Fragment() {
    ...
    override fun onPause() {
        ...
        binding.webView.apply {
            ...
            //حذف اطلاعات کش شده وبسایت ها ( جهت رعایت حریم خصوصی )
//            clearMatches()
//            clearHistory()
//            clearFormData()
//            clearSslPreferences()
    ...
    override fun onCreateContextMenu(menu: ContextMenu, v: View, menuInfo: ContextMenu.ContextMenuInfo?) {
        ...
        when(result.type){
            WebView.HitTestResult.IMAGE_TYPE -> {
                menu.add("بازکردن در زبانه جدید")
                menu.add("بازکردن در همین صفحه")
    ...
    override fun onContextItemSelected(item: MenuItem): Boolean {
        ...
        when(item.title){
            ...
            "ذخیره عکس" ->{
                if(imgUrl != null) {
                    if (imgUrl.contains("base64")) {
                        ...
                        Snackbar.make(binding.root, "عکس ذخیره شد", 3000).show()
                    }
            ...
            "اشتراک گذاری" -> {
                ...
                else Snackbar.make(binding.root, "لینک معتبر نمیباشد!", 3000).show()
            }
            "بستن" -> {}
        }
